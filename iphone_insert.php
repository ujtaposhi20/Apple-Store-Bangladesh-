...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($pid) && !empty($model))
		{
			...
			$query2 = "insert into iphone (img,pid,display,network,camera,chip,biometrics,capacity,color) values ('$img','$pid','$display','$network','$camera','$chip','$biometrics','$capacity','$color')";
...
<body>
    ...
    <form method="post" action="#" class="signup-form">
        ...
        <h1 style="padding-top: 130px">New iPhone</h1>
		...
		<div class="txtb">
            <input id="text" type="text" name="network" required>
            <span data-placeholder="Cellular Network"></span>
        </div>
		<div class="txtb">
