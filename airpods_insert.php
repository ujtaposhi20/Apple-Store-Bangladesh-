...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($pid) && !empty($model))
		{
			...
			$query2 = "INSERT INTO `airpods`(`img`, `pid`, `feature`, `chip`, `casetype`) VALUES ('$img','$pid','$feature','$chip','$casetype')";
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="cart-viwer.php"><i class="far fa-shopping-bag"></i></a>
                      </li>
                </ul>
            </div>
        </div>
    ...
    <form method="post" action="#" class="signup-form">
        ...
        <h1 style="padding-top: 130px">New AirPods</h1>
		...
		<div class="txtb">
            <input id="text" type="text" name="feature" required>
            <span data-placeholder="Feature"></span>
        </div>
		<div class="txtb">
		...
		<div class="txtb">
            <input id="text" type="text" name="casetype" required>
            <span data-placeholder="Case Type"></span>
        </div>
