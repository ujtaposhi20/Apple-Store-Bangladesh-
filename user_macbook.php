<?php
	...
	$query1 = "select m.img,p.model,p.price,m.display,m.chip,m.cpu,m.gpu,m.memory,m.ssd,m.camera,m.biometrics,m.weight,m.color,p.pid from macbook AS m inner join product AS p on m.pid=p.PID";
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="user_macbook.php" style="color: gray">MacBook</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div style="padding-top: 20px" class="col-3">
				...
				<form method="get">
                    <a href="buy.php?buy=<?php echo $result['pid'];?>&table=<?php echo $table;?>" class="signbtn"> <center>Buy</center> </a>
				</form>
            </div>
			<?php
