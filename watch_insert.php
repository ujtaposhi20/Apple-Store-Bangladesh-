...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($pid) && !empty($model))
		{
			...
			$query2 = "INSERT INTO `watch`(`img`, `pid`, `feature`) VALUES ('$img','$pid','$feature')";
...
<head>
   <meta charset="UTF-8">
    ...
    <title>New Apple Watch | Apple</title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <i class="far fa-shopping-bag"><a href="cart-viewer.php"></a></i>
                      </li>
                </ul>
            </div>
        </div>
    ...
    <form method="post" action="#" class="signup-form">
        ...
        <h1 style="padding-top: 130px">New Apple Watch</h1>
