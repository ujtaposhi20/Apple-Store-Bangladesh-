...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($pid) && !empty($model))
		{
			...
			$query2 ="INSERT INTO `macbookx`(`img`, `pid`, `display`, `chip`, `cpu`, `gpu`, `memory`, `ssd`, `camera`, `biometrics`, `weight`, `color`) VALUES ('$img','$pid','$display','$chip','$cpu','$gpu','$memory','$ssd','$camera','$biometrics','$weight','$color')";
			$query1 = "INSERT INTO `productx`(`PID`, `availability`, `Model`, `Price`, `Stored in`) VALUES ('$pid','$avail','$model','$price','')";
...
<body>
    ...
    <form method="post" action="#" class="signup-form">
        ...
        <h1 style="padding-top: 130px">New MacBook</h1>
		...
		<div class="txtb">
            <input id="text" type="text" name="cpu" required>
            <span data-placeholder="CPU"></span>
        </div>
		<div class="txtb">
            <input id="text" type="text" name="gpu" required>
            <span data-placeholder="GPU"></span>
        </div>
		<div class="txtb">
            <input id="text" type="text" name="memory" required>
            <span data-placeholder="Memory"></span>
        </div>
		<div class="txtb">
            <input id="text" type="text" name="ssd" required>
            <span data-placeholder="SSD"></span>
        </div>
		<div class="txtb">
		...
		<div class="txtb">
            ...
            <span data-placeholder="Weight"></span>
        </div>
		<div class="txtb">
