<?php
	...
	$query1 = "select ac.img,p.model,p.price,p.pid from accessories AS ac inner join product AS p on ac.pid=p.pid";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="user_accessories.php" style="color: gray;">Accessories</a>
                    </li>
                    <li class="nav-item">
